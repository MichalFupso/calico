...
func runDiags(logDir string) error {
	...
	cmds := []diagCmd{
		...
		{"Dumping proxy ARP entries", "ip neigh show proxy", "ip_neigh_proxy"},
		{"Dumping proxy NDP entries", "ip -6 neigh show proxy", "ip_neigh_proxy_v6"},
		{"Dumping LB proxy ARP dummy routes", "ip route show dev cali-lb-arp", "ip_route_cali_lb_arp"},
